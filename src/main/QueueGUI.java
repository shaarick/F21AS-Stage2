...
public class QueueGUI extends JFrame implements Observer2, ActionListener, Observer3 {
	
	private JLabel label, label2, label3, time;
...
//        }
	...
	public void update(Customer c) {
		...
		if((queue.size() >1) & (StaffGUI.count < 3)) {
	...
	@Override
	public void update3(Customer c) {
		...
		System.out.println("got into update");
			...
			Boolean x = model.removeElement(str);
			System.out.println("remove: " + x);
			model2.addElement(c.getName());
	}
